...
class _PeerFriendsState extends State<PeerFriends> {
  ...
  Widget build(BuildContext context) {
    final authStore = Provider.of<AuthStore>(context).token;

    // return ChangeNotifierProvider(
    //   create: (context) => PeerStore(authStore),
    //   child: const PeerScaffold(),
    // );

    return const PeerScaffold();
  }
}
...
class PeerScaffold extends StatefulWidget {
  const PeerScaffold({super.key});

  @override
  State<PeerScaffold> createState() => _PeerScaffoldState();
}

class _PeerScaffoldState extends State<PeerScaffold> {
  @override
  void initState() {
                ...
                return ListView(
                  ...
                  children: [
                    ...peerStore.peerData.data
                        .map(
                          (peer) => ListTile(
                            title: Text('${peer.firstName} ${peer.firstName}'),
